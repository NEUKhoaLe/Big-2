...
class ServerBoard2(ServerAbstractBoard):
    def __init__(self):
        super().__init__()
        ...
        # The player's Deck
        self.player_deck = ServerPlayerDeck(self.settings.player_deck_2_x, self.settings.player_y,
                                            self.settings.player_chosen_y, self.settings.play_deck_width_2,
                                            self.player_deck_collide_point)
        # The opponent's Deck
        self.opposite_deck = ServerOppositeDeck(self.settings.opposite_deck_2_x, self.settings.opposite_y,
        ...
        self.current_deck = ServerCurrentDeck(self.settings.current_deck_2_x, self.settings.current_deck_y,
                                              self.settings.play_deck_width_2)
        # The Discard pile
        self.discard_deck = ServerDiscardDeck(self.settings.discard_deck_x_2, self.settings.discard_deck_y_2)
