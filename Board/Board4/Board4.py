...
from Cards.Deck.PlayDeck.Left.LeftDeck import LeftDeck
...
from Cards.Deck.PlayDeck.Right.RightDeck import RightDeck
...
class Board4(AbstractBoard):
    def __init__(self, display, surface):
        ...
        self.current_deck = CurrentDeck(self.settings.current_deck_4_x, self.settings.current_deck_y,
                                        self.settings.play_deck_width_4, self.display, self.surface)
        # The Discard pile
        self.discard_deck = DiscardDeck(self.settings.discard_deck_x_4, self.settings.discard_deck_y_4,
